...
import excel using "2._ProcessedData/eventos_w10.xlsx", cellrange("A1:T63") first sheet("Sheet 1")
...
putexcel set "2._ProcessedData/tablas.xlsx", sh("stat_w10", replace) modify
