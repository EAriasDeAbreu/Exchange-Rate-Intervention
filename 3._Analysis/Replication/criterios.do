...
cd "C:\Users\Lenovo\OneDrive - Universidad de los Andes\Septimo Semestre\HE BC\Edmundo Andres Arias De Abreu\HE2 – Talleres\Proyecto"

import excel using "_ProcessedData/eventos.xlsx", cellrange("A1:T111") first sheet("Sheet 1")
...
putexcel set "_ProcessedData/tablas.xlsx", sh("stat", replace) modify
