...
df$tipo <- factor(df$Type, levels = c("No hubo intervencion", "Calls (IR decumulation)", "Calls (volatility control)", "Direct Purchase Auction", "Discretionary", "Puts (accumulation of IR)","Puts (volatility control)"), 
                  exclude =NA)
