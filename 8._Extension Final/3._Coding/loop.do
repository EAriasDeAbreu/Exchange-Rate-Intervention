...
kdensity vol_garch_pur, title("Volatility options effects on volatility measured with GARCH") lc(gs2) xtitle("SC effects distribution") xline(1.08, lc(stred)) xline(-232627, lc(stred)) xline(-79212, lc(stblue)) xlabel(,nogrid) ylabel(,nogrid) ytitle("density")
